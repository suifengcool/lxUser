<template>
    <div class="orderCreate">
        ...
        <div class="danzanBox">
            ...
            <a href="javascript:;" class="commitBtn"><span>游客评论</span><i class="iconfont icon-search"></i></a>
        </div>
        <div class="yudingBtnBox">
            <a href="javascript:;" class="orderBtn">立即预定</a>
